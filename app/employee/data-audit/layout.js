...
// Gating sama persis dengan app/employee/reports/layout.js — halaman audit
// ini menampilkan data lintas karyawan/payroll milik semua klien, jadi
// dibatasi khusus superadmin, bukan berbasis employee_modules biasa.
export default function DataAuditLayout({ children }) {
  const router = useRouter();
  const supabase = createClient();
  const { status, employee } = useModuleAccess('data_audit');
