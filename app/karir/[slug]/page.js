...
const translations = {
  id: {
    ...
    copied: 'Link disalin!',
    applyPlaceholder: 'Form aplikasi akan tersedia segera.',
  },
  en: {
    ...
    copied: 'Link copied!',
    applyPlaceholder: 'The application form will be available soon.',
  },
};
    ...
    <>
      ...
      <section className="px-10 py-10 bg-white">
        <div className="max-w-[900px] mx-auto">
          ...
          {/* Apply placeholder (Sprint B akan menggantikan ini dengan form) */}
          <div id="apply" className="border border-dashed border-[#E0E0E0] p-10 text-center text-sm text-[#6B6B6B]">
            {t.applyPlaceholder}
          </div>
        </div>
      </section>
