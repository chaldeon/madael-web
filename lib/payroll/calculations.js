...
export const PTKP_DATA = {
  ...
  TK2: { label: 'TK/2 — Belum Menikah, 2 Tanggungan', amount: 63000000, category: 'B' },
  TK3: { label: 'TK/3 — Belum Menikah, 3 Tanggungan', amount: 67500000, category: 'B' },
  K0: { label: 'K/0 — Menikah', amount: 58500000, category: 'A' },
  K1: { label: 'K/1 — Menikah, 1 Tanggungan', amount: 63000000, category: 'B' },
  K2: { label: 'K/2 — Menikah, 2 Tanggungan', amount: 67500000, category: 'B' },
  K3: { label: 'K/3 — Menikah, 3 Tanggungan', amount: 72000000, category: 'C' },
};
...
// TER Kategori C — sebelumnya tidak ada sama sekali, jadi K/3 keliru ikut
// tabel B. Sumber: Ortax, Daftar Tarif PPh Pasal 21 (Feb 2024), sesuai
// Lampiran PMK 168/2023.
const TER_C = [
