...
export const MODULE_REGISTRY = [
  ...
  { key: 'absensi', name: 'Absensi', desc: 'Clock in/out, GPS, ajukan koreksi, dan (khusus superadmin) kelola jadwal & approval', href: '/employee/absensi', status: 'live', icon: Clock },
  ...
  { key: 'activity_log', name: 'Activity Log', desc: 'Audit trail aksi penting lintas modul (khusus superadmin)', href: '/employee/activity-log', status: 'live', icon: History },
];
