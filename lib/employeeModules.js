...
export const MODULE_REGISTRY = [
  ...
  { key: 'absensi', name: 'Absensi', desc: 'Clock in/out, GPS, dan flag keterlambatan', href: '/employee/absensi', status: 'in_progress', icon: Clock, branch: 'feat/absensi-fondasi' },
  ...
  { key: 'payroll', name: 'Payroll', desc: 'Employee master data dan struktur gaji', href: '/employee/payroll', status: 'in_progress', icon: Wallet, branch: 'feat/payroll-fondasi' },
