import {
  ...
  ClipboardCheck, CalendarCheck, FileSpreadsheet, UserCircle, UserCheck, Megaphone, Banknote,
} from 'lucide-react';
...
export const MODULE_REGISTRY = [
  ...
  { key: 'profile', name: 'Profil Saya', desc: 'Update data pribadi: alamat, kontak darurat, rekening, NPWP, BPJS', href: '/employee/profile', status: 'live', icon: UserCircle, layer: 'personal' },
  ...
  { key: 'reimbursement', name: 'Reimbursement Saya', desc: 'Ajukan klaim biaya (transport, kesehatan, dll) dan lihat riwayatnya', href: '/employee/reimbursement', status: 'live', icon: Banknote, layer: 'personal' },
  ...
  { key: 'profile_admin', name: 'Kelola Perubahan Profil', desc: 'Review dan approve/reject pengajuan perubahan data pribadi karyawan', href: '/employee/profile/admin', status: 'live', icon: UserCheck, layer: 'hris' },
  ...
  { key: 'announcements_admin', name: 'Kelola Pengumuman', desc: 'Buat dan kelola pengumuman internal yang tampil di dashboard semua karyawan', href: '/employee/announcements/admin', status: 'live', icon: Megaphone, layer: 'hris' },
  { key: 'reimbursement_admin', name: 'Kelola Reimbursement', desc: 'Review dan approve/reject klaim reimbursement semua karyawan', href: '/employee/reimbursement/admin', status: 'live', icon: Banknote, layer: 'hris' },
  ...
  { key: 'data_audit', name: 'Kelengkapan Data Karyawan', desc: 'Audit gap data Employee List, Payroll, dan Jadwal Kerja (khusus superadmin)', href: '/employee/data-audit', status: 'live', icon: ClipboardCheck, layer: 'general' },
];
...
export const MODULE_OPTIONS = [
  ...
  { key: 'profile_admin', label: '— Sub: Kelola Perubahan Profil' },
  ...
  { key: 'reimbursement_admin', label: '— Sub: Kelola Reimbursement' },
  { key: 'payroll', label: 'Payroll' },
  { key: 'announcements_admin', label: 'Kelola Pengumuman' },
...
export const DEFAULT_MODULE_ACCESS = ['kalkulator', 'absensi', 'payslip', 'leave_request', 'profile', 'reimbursement'];