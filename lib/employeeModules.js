import {
  ...
  ClipboardCheck, CalendarCheck, FileSpreadsheet, UserCircle, UserCheck, Megaphone,
} from 'lucide-react';
...
export const DEFAULT_MODULE_ACCESS = ['kalkulator', 'absensi', 'payslip', 'leave_request', 'profile'];